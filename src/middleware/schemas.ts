...
const postLazy: z.ZodLazy<any> = z.lazy(() => User);
const replyLazy: z.ZodLazy<any> = z.lazy(() => User);
...
export const Account = User.pick({
    ...
    password: z.string().min(8, 'at least 8 chars').refine(containsNumber, 'Must contain at least 1 number').refine(containsSpecial, 'Must contain at least 1 special character'),
}).strict();
